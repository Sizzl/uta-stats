...
$pic[$i]['default']['font'] = 'verdanab.ttf';
...
$pic[$i]['process'][$j]['fontsize'] = 13;
$pic[$i]['process'][$j]['x_from'] = 30;
$pic[$i]['process'][$j]['y_from'] = 23;
$j++;
$pic[$i]['process'][$j]['type'] = 'text';
$pic[$i]['process'][$j]['value'] = '%GAMENAME% Rank %RT%';
$pic[$i]['process'][$j]['fontsize'] = 9;
$pic[$i]['process'][$j]['x_from'] = 5;
$pic[$i]['process'][$j]['y_from'] = 46;
$j++;
$pic[$i]['process'][$j]['type'] = 'text';
$pic[$i]['process'][$j]['value'] = 'Acc/Eff:';
$pic[$i]['process'][$j]['fontcolor'] = 'DDDD20';
$pic[$i]['process'][$j]['x_from'] = 5;
...
$pic[$i]['process'][$j]['value'] = '%TOTAL_ACC% / %TOTAL_EFF%';
$pic[$i]['process'][$j]['x_from'] = 70;
$pic[$i]['process'][$j]['y_from'] = 69;
$j++;
$pic[$i]['process'][$j]['type'] = 'text';
