...
mysql_query("DELETE FROM `uts_pinfo` WHERE `id` = '".$mplayer2."';") or die("am1: ".mysql_error());
	echo'<td class="grey" align="left" width="400">Done</td>
</tr>
<tr>
	<td class="smheading" align="left" width="200">Updating Player Records</td>';
mysql_query("UPDATE `uts_player` SET `pid` = '".$mplayer1."' WHERE `pid` = '".$mplayer2."';") or die("am2: ".mysql_error());
	echo'<td class="grey" align="left" width="400">Done</td>
</tr>
<tr>
	<td class="smheading" align="left" width="200">Updating Weapon Records (except summary totals)</td>';
mysql_query("UPDATE `uts_weaponstats` SET `pid` = '".$mplayer1."' WHERE `pid` = '".$mplayer2."' AND `matchid` > 0;") or die("am3: ".mysql_error());
mysql_query("DELETE FROM `uts_weaponstats` WHERE `pid` = '".$mplayer2."';") or die("am4: ".mysql_error());
	echo'<td class="grey" align="left" width="400">Done</td>
</tr>
<tr>
	<td class="smheading" align="left" width="200">Updating Player Weapon Stats summary totals:</td>';
mysql_query("DELETE FROM `uts_weaponstats` WHERE `matchid`='0' AND `pid` = '".$mplayer1."'") or die("am5: ".mysql_error());
...
mysql_query("UPDATE `uts_rank` SET `pid` = '".$mplayer2."' WHERE `pid`= '".$mplayer1."';") or die("am9: ".mysql_error());
echo'<td class="grey" align="left" width="400">Done</td>
</tr>
<tr>
...
$q_nrank = mysql_query($sql_nrank) or die("am10: ".mysql_error());
while ($r_nrank = mysql_fetch_array($q_nrank)) {

	mysql_query("INSERT INTO `uts_rank` SET `time` = '".$r_nrank['time']."', `pid` = '".$mplayer1."', `gid` = '".$r_nrank['gid']."', `rank` = '".$r_nrank['rank']."', `prevrank` = '".$r_nrank['prevrank']."', matches = '".$r_nrank['matches']."';") or die("am11: ".mysql_error());
}
